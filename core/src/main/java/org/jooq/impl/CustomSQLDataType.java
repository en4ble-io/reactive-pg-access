...
public final class CustomSQLDataType {
    ...
    public static final DataType<JsonArray> JSON_ARRAY = new DefaultDataType<>(null, JsonArray.class, "_json");
    public static final DataType<JsonArray> JSONB_ARRAY = new DefaultDataType<>(null, JsonArray.class, "_jsonb");
