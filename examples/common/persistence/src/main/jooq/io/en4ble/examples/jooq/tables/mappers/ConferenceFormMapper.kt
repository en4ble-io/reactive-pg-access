...
import io.en4ble.examples.jooq.tables.pojos.ConferenceForm
...
class ConferenceFormMapper:io.en4ble.pgaccess.mappers.AbstractJooqMapper<ConferenceForm>() {
    companion object {
        private val instance = io.en4ble.examples.jooq.tables.mappers.ConferenceFormMapper()
        fun instance():ConferenceFormMapper {
            return instance
        }
        fun map(row:io.vertx.sqlclient.Row):ConferenceForm {
            return instance.toDto(row)
        }
        fun map(res:io.vertx.sqlclient.RowSet<io.vertx.sqlclient.Row>  ):List<ConferenceForm>  {
            return instance.toList(res)
        }
    }
    @SuppressWarnings("Duplicates", "unused")
override fun toDto(row:io.vertx.sqlclient.Row, offset:Int):ConferenceForm {
        val dto = ConferenceForm()
