...
class ConferenceV1DtoMapper:io.en4ble.pgaccess.mappers.AbstractJooqMapper<ConferenceV1Dto>() {
    companion object {
        private val instance = io.en4ble.examples.jooq.tables.mappers.ConferenceV1DtoMapper()
